 ...
 *  representing the index of the directory in the stack to switch to -- this
 *  new directory is then moved to the top of the stack.
 ...
 *  number indicating the index of the directory in the stack to remove -- the
 *  current working directory will not change in this case.
